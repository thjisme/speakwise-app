...
import { ScriptInput } from './components/ScriptInput.tsx';
...
import type { AnalysisReport, AppStatus, Theme } from './types.ts';
import { analyzeSpeech, generateExampleSentences } from './services/geminiService.ts';
...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (status) {
      ...
      case 'recording':
        return <AudioRecorder script={script} onRecordingComplete={handleAudioReady} onCancel={() => setStatus('idle')} />;
      case 'uploading':
